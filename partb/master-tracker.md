...
| 2026-04-23 | HackerOne | Semrush | `www.semrush.com` public site, pricing/app-center surfaces, and auth entry points | YX / Codex | Program review, rendered homepage/pricing/apps testing, signup/login rendered flow analysis | In progress | None | `partb/targets/2026-04-23-hackerone-semrush/` |
