...
| 2026-04-23 | HackerOne | Shopify | `www.shopify.com`, `apps.shopify.com`, `shopify.dev`, and Shopify account-login surfaces | YX / Codex | Program intake, attack-surface mapping, pre-auth DevTools review, login/app-store parameter analysis | In progress | None | `partb/targets/2026-04-23-hackerone-shopify/` |
